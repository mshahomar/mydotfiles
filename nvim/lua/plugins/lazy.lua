  ...
  performance = {
    rtp = {
      ...
      paths = {
        ...
        "/usr/share/lua/5.4/luarocks/?.lua",
        "/usr/share/lua/5.4/luarocks/?/init.lua",
      },
    },
  },
  rocks = {
    lua = "/usr/sbin/lua", -- path to your Lua 5.4 binary
    lua_version = "5.4.7", -- specify the exact version
    install_dir = "/usr/share/lua/5.4/luarocks", -- LuaRocks install directory
  },
  checker = {
    enabled = true,
    concurrency = nil,
  ...
  ui = {
    custom_keys = {
      ["<localleader>l"] = function(plugin)
        require("lazy.util").float_term({ "luarocks", "install", plugin.name })
      end,
    },
  },
  {
